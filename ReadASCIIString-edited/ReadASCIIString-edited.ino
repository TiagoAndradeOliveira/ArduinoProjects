...
void loop() {
  ...
  while (Serial.available() > 0) {
    ...
    if (Serial.read() == '\n') {
      ...
      //Switched some tinhs from the original exaxxmple, now, the ASCII string is puts the raw values of
      //PWM bits in each PWM output, that means, 255,255,255 = white light
